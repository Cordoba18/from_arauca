...
INSERT INTO `citys` (`id`, `city`, `id_departament`) VALUES
(1, 'Leticia', 1),
(2, 'Puerto Nariño', 1),
(3, 'Abejorral', 2),
(4, 'Abriaquí', 2),
...
INSERT INTO `codes` (`id`, `code`, `updated_at`, `created_at`) VALUES
(1, '8050276537', NULL, NULL);
...
ALTER TABLE `citys`
  ADD PRIMARY KEY (`id`),
  ADD KEY `fk_citys_departaments_idx` (`id_departament`);
