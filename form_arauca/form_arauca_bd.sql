...
-- -----------------------------------------------------
-- Table `form_arauca_bd`.`neighborhoods`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `form_arauca_bd`.`neighborhoods` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `neighborhood` VARCHAR(100) NOT NULL,
  `id_city` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_neighborhoods_citys1_idx` (`id_city` ASC),
  CONSTRAINT `fk_neighborhoods_citys1`
    FOREIGN KEY (`id_city`)
...
CREATE TABLE IF NOT EXISTS `form_arauca_bd`.`participants` (
  ...
  INDEX `fk_participants_neighborhoods1_idx` (`id_neighborhood` ASC),
  CONSTRAINT `fk_participants_citys1`
    FOREIGN KEY (`id_city`)
    REFERENCES `form_arauca_bd`.`citys` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_participants_neighborhoods1`
    FOREIGN KEY (`id_neighborhood`)
    REFERENCES `form_arauca_bd`.`neighborhoods` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `form_arauca_bd`.`codes`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `form_arauca_bd`.`codes` (
  `id` INT NULL,
